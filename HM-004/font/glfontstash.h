...
static void glfons__renderDraw(void* userPtr, const float* verts, const float* tcoords, const unsigned int* colors, int nverts)
{
	...
	glVertexPointer( 2, GL_FLOAT, sizeof(float) *2, (GLvoid*) verts );
	glTexCoordPointer( 2, GL_FLOAT, sizeof(float) *2, (GLvoid*) tcoords );
	glColorPointer( 4, GL_UNSIGNED_BYTE, sizeof( unsigned int ), (GLvoid*) colors );
